...
class acf_field_icon_font extends acf_field
{
    ...
    */
    ...
    function render_field($field)
    {
        ...
        echo '<div class="mdi-icon-wrapper">';
        echo '<div class="mdi-icon-preview _' . $this->selectedIcon . '"></div>';
        ...
        echo '<div class="mdi-container">';

        echo '<div class="mdi-search">';
        echo '<input type="text" name="mdi_search_icon" placeholder="Search..." autocomplete="off" class="mdi-search-icon">';
        echo '</div>';

        echo '<ul class="mdi-list">';

        if (is_array($this->iconNames)) {
            foreach ($this->iconNames as $key => $value) {
                $selected = ($this->selectedIcon == $value) ? " active" : null;
                echo '<li class="_' . $value . $selected . '" data-value="' . $value . '"><span>' . $value . '</span></li>';
            }
        }
