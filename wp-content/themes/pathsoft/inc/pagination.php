...
if ( ! function_exists( 'understrap_pagination' ) ) {
	 ...
	 */
	function understrap_pagination( $args = array(), $class = 'pagination-list' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '<i class="material-icons md-24">chevron_left</i>', 'understrap' ),
				'next_text'          => __( '<i class="material-icons md-24">chevron_right</i>', 'understrap' ),
				'type'               => 'array',
